...
def test_send_returns_message_id() -> None:
    route = respx.post("https://mailgoat.example/api/v1/messages/send").respond(
        status_code=200,
...
def test_send_raises_api_error() -> None:
    respx.post("https://mailgoat.example/api/v1/messages/send").respond(
        status_code=401,
...
def test_send_raises_network_error() -> None:
    ...
    respx.post("https://mailgoat.example/api/v1/messages/send").mock(side_effect=raise_timeout)
